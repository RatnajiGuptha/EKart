        ...
        <div className="d-flex justify-content-center">
            <div className="cart-container">
                {cartItems.map((item) => (
                    <div key={item.id} className="items-container" >
                        ...
                        <div>
                            <p className="product-price"> Quantity: <span style={{ fontStyle: "italic", fontWeight: "bold" }}>{item.qty} </span></p>
                            <p className="product-price">Price: ₹ <span style={{ fontStyle: "italic", fontWeight: "bold" }}>{item.productPrice}/-</span></p>
                        </div>
                        <div className="m-2">
            ...
            <div>
                <div className="price-container table" >
                    ...
                    <p className="total-price">  Total Price:<span style={{ fontStyle: "italic" }}> ₹ {calculateTotalPrice().totalPrice}/- </span></p>
