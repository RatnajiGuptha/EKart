...
//				.route((p -> p.path("/api/electronicsProducts/updateProducts/**").uri("http://localhost:8200")))
				...
				.route((p -> p.path("/api/fashionProducts/getAllProducts").uri("http://localhost:8200")))
				.route((p -> p.path("/api/fashionProducts/getProductsById/**").uri("http://localhost:8200")))
				.route((p -> p.path("/api/fashionProducts/getProductsBySuitable/suitableFor/**").uri("http://localhost:8200")))
				.route((p -> p.path("/api/fashionProducts/getSuitableProductsById/suitableFor/**").uri("http://localhost:8200")))
				.route((p -> p.path("/api/fashionProducts/getProductsByGenderAndType/suitablefor/**").uri("http://localhost:8200")))
				.route((p -> p.path("/api/fashionProducts/getSuitableProductsByTypeAndId/suitablefor/**").uri("http://localhost:8200")))
